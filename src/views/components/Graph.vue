<template>
    <div :style="{ width: width + 'px', height: height + 'px', border: '1px solid grey' }">
...
<script>
    export default {
        ...
        created() {
            ...
            /*console.log("fx" + this.data().fx)
            console.log("fy" + this.data().fx)*/
        ...
        mounted() {
            ...
            // Some caption
            //right bottom graph explanation
        ...
        methods: {
            tick() {
                ...
                graph.selectAll(".edgelabel").attr("transform", transformEdgeLabel)
                graph.selectAll("circle").attr("transform", transform)
                graph.selectAll(".nodelabel").attr("transform", transform)
            ...
            updateData() {
                ...
                graph.selectAll(".edgelabel").remove()
                graph.selectAll(".edgelabel")
                    .data(this.links)
                    .enter().append("text")
                ...
                graph.selectAll(".nodelabel").remove()
                graph.selectAll(".nodelabel")
                    .data(this.nodes)
                    .enter().append("text")
                    .attr("x", 0)
                    .attr("y", ".31em")
            ...
            updateCaption() {
                ...
                caption.select('rect')
                    .attr('height', (captionYPadding * 2) + lineHeight * (this.classes.length))
                ...
                /*linkCaption.selectAll('.nodelabel')
                    .data(this.linkTypes)
                    .enter().append('text')
                ...
                classCaption.selectAll('circle')
                    ...
                    .attr('cy', (d) => captionYPadding + lineMiddle +
                        (lineHeight * (this.classes.indexOf(d))))
                    .attr('class', (d) => d.toLowerCase());

                classCaption.selectAll('.nodelabel')
                    .data(this.classes)
                    .enter().append('text')
                    .attr('x', captionXPadding + 20)
                    .attr('y', (d) => captionYPadding + (lineMiddle + 5) +
